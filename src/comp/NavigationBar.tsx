...
const NavigationBar: FC = () => {
    return (
        <nav className="transition ease-in-out opacity-50 hover:opacity-100 sticky top-0 z-50 bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-dark">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        ...
                        <NavigationLink title={"Blog"} href={"https://pingvin12.github.io/blog"} id={""}/>
                        <ThemeToggleSwitch title={"Theme"}/>
                    </ul>
                </div>
            </div>
        </nav>
